...
#include "ui_MyDialogGui.h"

#include "Util.h"

MyDialogGui::MyDialogGui(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::MyDialogGui)
{
    ui->setupUi(this);
}

MyDialogGui::~MyDialogGui()
{
    delete ui;
}


void MyDialogGui::setLabel(QImage &img)
{
    ui->label->setPixmap(QPixmap::fromImage(img));
}

void MyDialogGui::setFNames(std::vector<QString> &fNames, QString dir)
{
    this->fNames = fNames;
    this->fileIndex = 0;
    this->dir = dir;
...
void MyDialogGui::on_pushButton_clicked()
{
    fileIndex--;
...
void MyDialogGui::on_pushButton_2_clicked()
{
    fileIndex++;
...
void MyDialogGui::on_comboBox_activated(int index)
{
    QString fileName = this->dir + "/" + this->fNames[fileIndex] + ".jpg";
    QImage image(fileName);
